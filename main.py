def enter_quantitat_objecte():
    global quantitat_obj
    quantitat_obj = game.ask_for_number("Introdueix la quantitat que vulguis", 3)
...
def show_options():
    ...
    option1 = sprites.create(img("""
            ...
            """),
        SpriteKind.food)
    option1.set_position(19, 97)
    option1.set_stay_in_screen(True)
    option2 = sprites.create(img("""
            ...
            .......eebdeeebdeee4dbbdd.........
            .......eebbeeebbeee4b44bd.........
            .......dbeeebbbbebdb4ebbdbbb......
            .....bbddbeebddebbddeebdbe4bb.....
            .....ebddbeebddebbddeebddeebb.....
            .....ebbdbeebbdebbddeebddeebb.....
            .....ebbbeeebbdeebddeebbdee44.....
            .....ebbbbebbbbebbbbebbbddbbd.....
            ......eebbeeebebbebebeebebbb......
            ......eeebeebebbeebbbebbebbb......
            .......eeebeebbbebbbbbbbbbb.......
            .......bebbeeeeedbeeeebbeeb.......
            .......eeeebeeeebbbebebbb.........
            .........eeeeeeebbbbbbbbb.........
            .............ebbeebebbbbb.........
            ..................................
            ...
            """),
        SpriteKind.food)
    option2.set_position(93, 97)
    option2.set_stay_in_screen(True)
    option3 = sprites.create(img("""
            ...
            .................bbbbddd1....
            .................bbbddddd....
            ....ddddddd...b1bbbbdddddd...
            ...dddddddddddddbbbbddddbb...
            ..ddddddddddddbbbbbbddbbbb...
            .1dddddddddddbbbbbbbddbbbb...
            .bbdddddddddbbbbbbbbdddd.....
            ..bbbddddddddbdbbbbdd.dd.....
            ..bbbddddddbbbdddbdd.........
            ..bbbdddddbbbbdddddd.........
            .bbbbdbdddbbdbdddddd.........
            .bdbbbbbbbbbdbddddd3.........
            ...
            """),
        SpriteKind.food)
    option3.set_position(63, 87)
    option3.set_stay_in_screen(True)
    option4 = sprites.create(img("""
            ...
            .........d44d4d44dddd..................
            .......444ddd44444444ddd...............
            ......d444444444444444d4dd.............
            .....444d4444444444ed4d444dd...........
            ....4dd44444444ddd4444d4444dd..........
            ...dd444444444d44dd44ddd4444dd.........
            ...44444444ddddd44ddd444dd4eddd........
            ...44444d44e4e444d4ddddd4d4444d........
            ...444444444d4e4ddddddbd4d4d444d.......
            ...4e44444444444444dd44ddd4d4de4.......
            ...d444444ed4444ddddd44dd4dd44444......
            ....44444e444444e4ddd44dd444444ded.....
            ....b44444444444444dddd44d444444d4.....
            .....d44e444444e4444444444444c4444.....
            ......44444e4444444444444444444444d....
            .......44444444444444444e444444444d....
            ........d444e44444444444ee444e44444....
            .........b4444e444444d44e4444e44444....
            .........dde44444444ddd44444444444.....
            ..........ddd44444d4444eee44444e44.....
            ...........dddd444444d44444444444d.....
            ............dddd444ddd44444e444dd......
            ..............dddbdd44444dd4d4dd.......
            ...............ddddddddd4d44dddd.......
            .................dddddddddddddd........
            ....................ddddddddd..........
            ...
            """),
        SpriteKind.food)
    option4.set_position(33, 38)
    option4.set_stay_in_screen(True)
    option5 = sprites.create(img("""
            ...
            ...........eefdffdece..............b...
            ...........eefeecbbeb...e4f....bbbb....
            ...........4ec4eeddbeebfeebbbbcceeb....
            ...........ef.eeeedddddeeedbbccccebb...
            ..........ef...eeddddedffebbbbcccbe....
            ..........ee...eeddd4ebfffdbbccccbeb...
            ...............eedd14edfff4bbcbdb.ec...
            ...............4bed144efffdbccbcc..c...
            ...............4dfc14effffebc..b...b...
            ...............4eff1deffffedc..........
            ...............bbffddeffffebc..........
            ................effdefff.febc..........
            ...
            .............ce..........edddc....bbbbb
            ......................bb.bdddb.bbbbbbbb
            ............c.b...b.b..bbbbbbdbbbbbbbbb
            ............bbbebbdbdbbebbbbbebe444444e
            .......b...bbdbeebbbbbebbbbbee444ee44ee
            ..........bcbbdddbbbb44e444eeee4eee44ee
            ...b.b.bbbbbbb4deb444e4e4e4eeeeeeee444e
            b..b.bbbbb444444444e44eeeeeeeeeeee44444
            ...
            """),
        SpriteKind.food)
    option5.set_position(137, 97)
    option5.set_stay_in_screen(True)

def on_on_overlap(sprite, otherSprite):
    if otherSprite == option1:
        option1.start_effect(effects.confetti, 500)
        player2.say_text("Prem A per confimar", 800, False)
        if controller.A.is_pressed():
            enter_quantitat_objecte()
            pi_a_gallina()
    else:
        if otherSprite == option2:
            option2.start_effect(effects.confetti, 500)
            player2.say_text("Prem A per confimar", 800, False)
            if controller.A.is_pressed():
                enter_quantitat_objecte()
                pi_a_ous()
            ...
            if otherSprite == option3:
                option3.start_effect(effects.confetti, 500)
                player2.say_text("Prem A per confimar", 800, False)
                if controller.A.is_pressed():
                    enter_quantitat_objecte()
                    pi_a_cabra()
                ...
                if otherSprite == option4:
                    option4.start_effect(effects.confetti, 500)
                    player2.say_text("Prem A per confimar", 800, False)
                    if controller.A.is_pressed():
                        enter_quantitat_objecte()
                        pi_a_patata()
                    ...
                    if otherSprite == option5:
                        option5.start_effect(effects.confetti, 500)
                        player2.say_text("Prem A per confimar", 800, False)
                        if controller.A.is_pressed():
                            enter_quantitat_objecte()
                            pi_a_cavall()
